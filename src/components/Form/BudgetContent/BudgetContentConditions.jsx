    ...
    <>
      <Form.ContainerInput>
        ...
        <select
          ...
          onChange={(e) =>
            updateBudget("conditions", "paymentMethod", e.target.value)
          }
        >
          {options.map((value) => (
      ...
      <Form.ContainerInput size="large">
        ...
        <Form.Input
          ...
          onChange={(e) =>
            updateBudget("conditions", "shippingTime", e.target.value)
          }
        />
      </Form.ContainerInput>
      ...
      <Form.ContainerInput size="xx-large">
        ...
        <Form.Input
          ...
          onChange={(e) =>
            updateBudget("conditions", "paymentConditions", e.target.value)
          }
        />
      </Form.ContainerInput>
      ...
      <Form.ContainerInput size="xx-large">
        ...
        <Form.Input
          ...
          onChange={(e) =>
            updateBudget("conditions", "warranty", e.target.value)
          }
        />
      </Form.ContainerInput>
      ...
      <Form.ContainerInput size="xx-large">
        ...
        <Form.TextArea
          ...
          onChange={(e) =>
            updateBudget("conditions", "obsBudget", e.target.value)
          }
        />
      </Form.ContainerInput>
      ...
      <Form.ContainerInput size="xx-large">
        ...
        <Form.TextArea
          ...
          onChange={(e) =>
            updateBudget("conditions", "termsConditions", e.target.value)
          }
        />
      </Form.ContainerInput>
    </>
