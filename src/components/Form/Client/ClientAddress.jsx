  ...
  return (
    <>
      <Form.ContainerInput size="xx-large">
        <Form.Label text={"Rua"} htmlFor={"street"} />
        <Form.Input
      ...
      <Form.ContainerInput>
        <Form.Label text={"Número"} htmlFor={"number"} />
        <Form.Input
          placeholder={"0000"}
          type={"number"}
          id={"number"}
      ...
      <Form.ContainerInput size="medium">
        <Form.Label text={"Cidade"} htmlFor={"city"} />
        <Form.Input
      ...
      <Form.ContainerInput>
        <Form.Label text={"Estado | UF"} htmlFor={"state"} />
        <Form.Input
          placeholder={"ex.: SC"}
          type={"text"}
          id={"state"}
      ...
      <Form.ContainerInput>
        ...
        <Form.Input
          ...
          onChange={(e) =>
            updateSubClient("address", "zipCode", maskZipCode(e.target.value))
          }
        />
      </Form.ContainerInput>
    </>
