...
export default function LoginContent({
    ...
    return ( <
        ...
        header > <
        div className = '
        w - full flex flex - 1 flex - col place - items - center place - content - start '> <
        ...
        /> {
        formErrors.email && < span className = 'text-sm font-semibold text-[#e74d3c]' > {
            formErrors.email
        } < /span>} < /
        div >
        <
        ...
        /> {
        formErrors.password && < span className = 'text-sm font-semibold text-[#e74d3c]' > {
            formErrors.password
        } < /span>} < /
        div > <
        div className = 'flex h-fit w-full flex-row flex-wrap items-center justify-between gap-y-4 pb-[7vh]' >
        <
        Link className = 'text-base text-[#aaa] underline'
        to = 'forgot-password' >
        Esqueci minha senha <
        /Link> < /
        div >
