...
const benefits = ["Sem cartao", "Cancele quando quiser", "Login com Google"];

const HeroSection = () => {
    return (
        <section
            className="mx-auto flex min-h-dvh w-[90%] flex-wrap place-content-center place-items-center gap-8 py-20"
            id="top"
        >
            <motion.div
            ...
            >
                ...
                <p className="mx-auto flex max-w-3xl py-10 text-center text-sm leading-7 text-[rgb(170,170,190)] sm:text-base">
                    Crie orçamentos profissionais em minutos, acompanhe
                    aprovacoes e tenha mais controle sobre o seu faturamento.
                    Tudo em um so lugar, sem planilhas, sem WhatsApp baguncado.
                </p>
